...
public class SubsetFinder
{
   ...
   * represented as a string in which the elements in the set are distinct characters.  
   * Order of the characters does not matter.
   * @param givenSet
   *   string consisting of distinct characters representing elements of a set
   * @param size
   *   size of subsets to select
   * @return
   *   list of all possible size-element subsets of the given set
   */
